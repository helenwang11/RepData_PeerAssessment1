...
```
Mean total steps is `r options(scipen=999999);mean.steps`;
Median total steps is `r options(scipen=999999);median.steps`
...
```
Interval `r max_interval` has the max number of steps.
...
```
There are `r number.na` missing values in the data.
